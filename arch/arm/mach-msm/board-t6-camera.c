...
void t6_vcm_vreg_on(void);
void t6_vcm_vreg_off(void);
#endif
...
static struct msm_gpiomux_config t6_cam_common_configs[] = {
	{
...
static int t6_csi_vreg_on(void);
static int t6_csi_vreg_off(void);

struct msm_camera_device_platform_data t6_msm_camera_csi_device_data[] = {
	{
		.ioclk.mclk_clk_rate = 24000000,
		.ioclk.vfe_clk_rate  = 228570000,
		.csid_core = 0,
		.camera_csi_on = t6_csi_vreg_on,
		.camera_csi_off = t6_csi_vreg_off,
...
int t6_flashlight_control(int mode)
{
...
static struct msm_camera_sensor_flash_src msm_camera_flash_src = {
	...
	.camera_flash = t6_flashlight_control,
};
#endif
#endif
...
static int t6_use_ext_1v2(void)
{
	return 1;
}

static int t6_rawchip_vreg_on(void)
{
	int rc;
...
static int t6_rawchip_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
...
static struct msm_camera_rawchip_info t6_msm_rawchip_board_info = {
	...
	.camera_rawchip_power_on = t6_rawchip_vreg_on,
	.camera_rawchip_power_off = t6_rawchip_vreg_off,
	.rawchip_use_ext_1v2 = t6_use_ext_1v2,
};

struct platform_device t6_msm_rawchip_device = {
	.name	= "yushanII",
	.dev	= {
		.platform_data = &t6_msm_rawchip_board_info,
	},
};
#endif
...
static void t6_yushanii_probed(enum htc_camera_image_type_board htc_image)
{
...
static struct msm_actuator_info rumbas_actuator_info = {
	...
	.otp_diviation	= 85,
#if defined(CONFIG_RUMBAS_ACT)
	.vcm_wa_vreg_on = t6_vcm_vreg_on,
	.vcm_wa_vreg_off = t6_vcm_vreg_off,
#endif
};
#endif
...
#ifdef CONFIG_IMX175
static int t6_imx175_vreg_on(void)
{
	int rc;
...
#if 0	
	if (system_rev == 0 || !t6_use_ext_1v2()) { 
#else
	if (1) {
#endif	
...
static int t6_imx175_vreg_off(void)
{
	int rc = 0;
	unsigned gpio_cam_d1v2_en = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx175_data = {
	.sensor_name	= "imx175",
	.camera_power_on = t6_imx175_vreg_on,
	.camera_power_off = t6_imx175_vreg_off,
	.pdata	= &t6_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_IMX135
static int t6_imx135_vreg_on(void)
{
	int rc;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static int t6_imx135_vreg_off(void)
{
	int rc = 0;
	int gpio_cam_d1v2_en=0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_imx135_data = {
	.sensor_name	= "imx135",
	.camera_power_on = t6_imx135_vreg_on,
	.camera_power_off = t6_imx135_vreg_off,
	.camera_yushanii_probed = t6_yushanii_probed,
	.pdata	= &t6_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_VD6869
static int t6_vd6869_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int t6_vd6869_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_vd6869_data = {
	.sensor_name	= "vd6869",
	.camera_power_on = t6_vd6869_vreg_on,
	.camera_power_off = t6_vd6869_vreg_off,
	.camera_yushanii_probed = t6_yushanii_probed,
	.pdata	= &t6_msm_camera_csi_device_data[0],
...
static int t6_ov4688_vreg_on(void)
{
	int rc =0;
	pr_info("%s\n", __func__);
...
static int t6_ov4688_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov4688_data = {
	.sensor_name	= "ov4688",
	.camera_power_on = t6_ov4688_vreg_on,
	.camera_power_off = t6_ov4688_vreg_off,
	.camera_yushanii_probed = t6_yushanii_probed,
	.pdata	= &t6_msm_camera_csi_device_data[0],
...
#ifdef CONFIG_IMX091
static int t6_imx091_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int t6_imx091_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_imx091_data = {
	.sensor_name	= "imx091",
	.camera_power_on = t6_imx091_vreg_on,
	.camera_power_off = t6_imx091_vreg_off,
	.pdata	= &t6_msm_camera_csi_device_data[0],
...
static int t6_s5k3h2yx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int t6_s5k3h2yx_vreg_off(void)
{
	int rc = 0;
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h2yx_data = {
	...
	.camera_power_on = t6_s5k3h2yx_vreg_on,
	.camera_power_off = t6_s5k3h2yx_vreg_off,
	.pdata	= &t6_msm_camera_csi_device_data[0],
...
static int t6_s5k6a1gx_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int t6_s5k6a1gx_vreg_off(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k6a1gx_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = t6_s5k6a1gx_vreg_on,
	.camera_power_off = t6_s5k6a1gx_vreg_off,
	.pdata	= &t6_msm_camera_csi_device_data[1],
...
#ifdef CONFIG_AR0260
static int t6_ar0260_vreg_on(void)
{
	int rc;
...
static int t6_ar0260_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ar0260_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = t6_ar0260_vreg_on,
	.camera_power_off = t6_ar0260_vreg_off,
	.camera_yushanii_probed = t6_yushanii_probed,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &t6_msm_camera_csi_device_data[1],
#else
...
#ifdef CONFIG_OV2722
static int t6_ov2722_vreg_on(void)
{
	int rc;
	pr_info("%s\n", __func__);
...
static int t6_ov2722_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov2722_data = {
	...
	.vcm_pwd	= 0,
	.vcm_enable	= 0,
	.camera_power_on = t6_ov2722_vreg_on,
	.camera_power_off = t6_ov2722_vreg_off,
	.camera_yushanii_probed = t6_yushanii_probed,
#ifdef CONFIG_CAMERA_IMAGE_NONE_BOARD
	.pdata	= &t6_msm_camera_csi_device_data[1],
#else
...
static struct i2c_board_info t6_camera_i2c_boardinfo_imx135_ar0260[] = {
#ifdef CONFIG_IMX135
		{
...
static struct i2c_board_info t6_camera_i2c_boardinfo_imx135_ov2722[] = {
#ifdef CONFIG_IMX135
		{
		I2C_BOARD_INFO("imx135", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_imx135_data,
...
static struct i2c_board_info t6_camera_i2c_boardinfo_vd6869_ar0260[] = {
#ifdef CONFIG_VD6869
		{
...
static struct i2c_board_info t6_camera_i2c_boardinfo_vd6869_ov2722[] = {
#ifdef CONFIG_VD6869
		{
		I2C_BOARD_INFO("vd6869", 0x20 >> 1),
		.platform_data = &msm_camera_sensor_vd6869_data,
...
struct i2c_board_info t6_camera_i2c_boardinfo_ov4688_0x6c_ov2722[] = {
...
struct i2c_board_info t6_camera_i2c_boardinfo_ov4688_0x20_ov2722[] = {
...
void t6_vcm_vreg_on(void)
{
	...
	rc = t6_rawchip_vreg_on();
	if (rc < 0) {
		pr_err("%s t6_rawchip_vreg_on failed\n", __func__);
		return;
	}
...
void __init t6_init_cam(void)
{
	int main_camera_id = CAMERA_SENSOR_ID_SONY_13M;
	pr_info("%s", __func__);
	msm_gpiomux_install(t6_cam_common_configs,
			ARRAY_SIZE(t6_cam_common_configs));
	...
	if (system_rev > 0) 
		main_camera_id = t6_main_camera_id();
	...
	if ( (((engineerid&1)==0) && (system_rev < 2)) ||
		...
		if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				t6_camera_i2c_boardinfo_vd6869_ar0260,
				ARRAY_SIZE(t6_camera_i2c_boardinfo_vd6869_ar0260));

			update_yushanII_flag(HTC_CAMERA_IMAGE_YUSHANII_BOARD);
		} else {

			
			msm_camera_sensor_ar0260_data.pdata = &t6_msm_camera_csi_device_data[1];
			

			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				t6_camera_i2c_boardinfo_imx135_ar0260,
				ARRAY_SIZE(t6_camera_i2c_boardinfo_imx135_ar0260));
		...
		if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				t6_camera_i2c_boardinfo_vd6869_ov2722,
				ARRAY_SIZE(t6_camera_i2c_boardinfo_vd6869_ov2722));

			update_yushanII_flag(HTC_CAMERA_IMAGE_YUSHANII_BOARD);
		} else if(main_camera_id == CAMERA_SENSOR_ID_OV_4M){
			if(1){
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					t6_camera_i2c_boardinfo_ov4688_0x20_ov2722,
					ARRAY_SIZE(t6_camera_i2c_boardinfo_ov4688_0x20_ov2722));
			}else{
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					t6_camera_i2c_boardinfo_ov4688_0x6c_ov2722,
					ARRAY_SIZE(t6_camera_i2c_boardinfo_ov4688_0x6c_ov2722));
			}
			update_yushanII_flag(HTC_CAMERA_IMAGE_YUSHANII_BOARD);
		}
		else {
			...
			msm_camera_sensor_ov2722_data.pdata = &t6_msm_camera_csi_device_data[1];
			

			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				t6_camera_i2c_boardinfo_imx135_ov2722,
				ARRAY_SIZE(t6_camera_i2c_boardinfo_imx135_ov2722));
